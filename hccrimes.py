# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 08:20:02 2021
...
# Plotting Dendrogram
z = linkage(airlines1, method = "complete", metric = "euclidean")
...
h_complete = AgglomerativeClustering(n_clusters=3,linkage="complete",affinity="euclidean").fit(airlines1) 
h_complete.labels_
...
# creating a csv file 
airlines.to_csv("airlines_clust.csv", encoding = "utf-8")
import os
os.getcwd()
